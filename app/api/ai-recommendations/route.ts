...
export async function POST(request: Request) {
  try {
    ...
    מידע שחולץ מהתיאור:
    - מבוגרים: ${extractedData.adults || "לא צוין"}
    - ילדים: ${extractedData.children || "לא צוין"}
    - תינוקות: ${extractedData.babies || "לא צוין"}
    - חיות מחמד: ${extractedData.pets || "לא צוין"}
    - צרכים מיוחדים: ${extractedData.special_needs || "לא צוין"}
    - משך זמן מומלץ: ${extractedData.duration_hours || 72} שעות
